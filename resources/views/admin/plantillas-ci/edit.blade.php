                ...
                <form action="{{route('plantillas-ci.update', $plantilla->id)}}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-check">
                                    <input type="checkbox" name="requiere_acudiente_obligatorio" id="requiere_acudiente_obligatorio" class="form-check-input" value="1" {{old('requiere_acudiente_obligatorio', $plantilla->requiere_acudiente_obligatorio) ? 'checked' : ''}}>
