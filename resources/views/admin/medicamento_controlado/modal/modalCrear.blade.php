<div class="modal fade" tabindex="-1" id="modal-crear-medicamento" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="background: linear-gradient(-45deg, #0fd850, #f9d423, #23a6d5, #23d5ab); background-size: 400% 400%; animation: gradientBG 15s ease infinite;">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-primary" style="transition: all 0.15s ease 0s; height: inherit; width: inherit; background: rgba(255, 255, 255, 0.1); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2);">
                        <div class="card-header with-border" style="background: linear-gradient(135deg, #0fd850 0%, #23d5ab 100%); border-radius: 8px; padding: 15px; margin-bottom: 20px;">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group-glass">
                                            <label for="crear_nombre" style="color: white; font-weight: bold;">
                                                <i class="fas fa-prescription-bottle mr-2"></i>Nombre del Medicamento *
                                            </label>
                                            <input type="text" name="nombre" id="crear_nombre" class="form-control glass-input" required maxlength="200" placeholder="Ej: Morfina 10mg, Fentanilo 50mcg">
                                        </div>

                                        <div class="form-group-glass">
                                            <label for="crear_descripcion" style="color: white; font-weight: bold;">
                                                <i class="fas fa-info-circle mr-2"></i>Descripción
                                            </label>
                                            <textarea name="descripcion" id="crear_descripcion" class="form-control glass-input" rows="4" placeholder="Descripción opcional del medicamento: presentación, concentración, uso, etc."></textarea>
                                        </div>
                                        ...
                                        <div class="form-group-glass">
                                            ...
                                            <div class="custom-control custom-switch" style="padding-left: 3rem;">
                                                ...
                                                <label class="custom-control-label" for="crear_activo" style="color: white; font-weight: 600; padding-top: 2px;">
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 text-center">
                                        <div class="btn-group-ios">
                                            <button type="button" class="btn-ios btn-ios-warning" id="btn-limpiar-crear" onclick="limpiarFormCrear()">
                                                <i class="fas fa-eraser"></i>
                                                <span>Limpiar</span>
                                            </button>
                                            <button type="submit" class="btn-ios btn-ios-success" id="btn-guardar-crear">
